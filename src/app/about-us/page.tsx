...
const approaches: Approach[] = [
  ...
  },
  {
    ...
    icon: "fluent:gesture-swipe-20-filled",
    accent: "bg-pink-300",
  },
  {
    id: "scaling",
...
const MotionArticle = motion.article as unknown as React.ComponentType<ArticleProps>;

type InnerDivProps = React.ComponentPropsWithoutRef<"div"> & MotionProps;
const MotionInnerDiv = motion.div as unknown as React.ComponentType<InnerDivProps>;

export const AboutUs: React.FC = () => {
  return (
    <section className="w-full bg-white/60 dark:bg-gray-900/40 py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        {/* Small subtitle */}
        <p className="text-sm text-blue-600 font-medium tracking-wider mb-3">ABOUT US</p>
        ...
        <p className="text-gray-600 dark:text-gray-300 max-w-3xl mb-10">
          We combine research, creative experimentation and real-time data to deliver measurable and scalable digital growth.
          Below is our approach — a repeatable process that turns insights into strategy and strategy into results.
        </p>
        ...
        >
          {approaches.map((a) => (
            <MotionArticle
              ...
              className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 flex flex-col gap-4"
            >
              {/* Icon + blob */}
              <div className="flex items-start gap-4">
                ...
                >
                  ...
                  >
                    <Icon icon={a.icon} width="28" height="28" className="text-white" />
                  </MotionInnerDiv>
                </div>

                {/* Title */}
                <h3 className="text-lg font-semibold text-black dark:text-white mt-1">{a.title}.</h3>
              </div>

              {/* Description */}
              <p className="text-gray-600 dark:text-gray-300 text-sm flex-1">{a.description}</p>
        ...
        <div className="mt-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div>
            <h4 className="text-xl font-bold text-black dark:text-white">Ready to talk strategy?</h4>
            <p className="text-gray-600 dark:text-gray-300">Let’s map a roadmap that fits your business goals.</p>
          </div>
          <div>
            <a
              href="#contact"
